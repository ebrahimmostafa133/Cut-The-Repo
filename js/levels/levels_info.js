    ...
    boxes: [
        {
            ...
            levels: [
                ...
                },
                {
                    ...
                    "physics": {
                        ropes: [
                            { anchorX: 0.2, anchorY: 0.05, len: 0.25 },
                            { anchorX: 0.5, anchorY: 0.03, len: 0.5 },
                            { anchorX: 0.8, anchorY: 0.05, len: 0.3 }
                        ],
                        stars: [
                            { x: 0.35, y: 0.45 },
                            { x: 0.5, y: 0.35 },
                ...
                },
                {
                    ...
                    "physics": {
                        ropes: [
                            { anchorX: 0.15, anchorY: 0.06, len: 0.3 },
                            { anchorX: 0.4, anchorY: 0.02, len: 0.55 },
                            { anchorX: 0.7, anchorY: 0.03, len: 0.65 }
                        ],
                        stars: [
                            { x: 0.25, y: 0.40 },
                            { x: 0.5, y: 0.30 },
            ...
            levels: [
                {
                    ...
                    "physics": {
                        ropes: [
                            { anchorX: 0.3, anchorY: 0.05, len: 0.28 },
                            { anchorX: 0.7, anchorY: 0.04, len: 0.32 }
                        ],
                        stars: [
                            { x: 0.5, y: 0.50 }
                        ]
                ...
                },
                {
                    ...
                    "physics": {
                        ropes: [
                            { anchorX: 0.2, anchorY: 0.06, len: 0.22 },
                            { anchorX: 0.5, anchorY: 0.02, len: 0.52 },
                            { anchorX: 0.8, anchorY: 0.06, len: 0.25 }
                        ],
                        stars: [
                            { x: 0.35, y: 0.45 },
                            { x: 0.65, y: 0.55 }
                ...
                },
                {
                    ...
                    "physics": {
                        ropes: [
                            { anchorX: 0.1, anchorY: 0.07, len: 0.35 },
                            { anchorX: 0.35, anchorY: 0.02, len: 0.6 },
                            { anchorX: 0.65, anchorY: 0.01, len: 0.7 },
                            { anchorX: 0.9, anchorY: 0.07, len: 0.28 }
                        ],
                        stars: [
                            { x: 0.25, y: 0.35 },
                            { x: 0.5, y: 0.25 },
